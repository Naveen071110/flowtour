...
const PRODUCT_HUNT_URL =
  "https://www.producthunt.com/products/flowtour?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-flowtour";
    ...
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-zinc-800 selection:text-white relative overflow-hidden font-sans">
      ...
      <main>
        ...
        <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 px-4 sm:px-6 max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 border border-zinc-800 bg-zinc-900/60 text-zinc-400 text-xs font-mono px-3.5 py-1.5 rounded-full">
          ...
          {/* Official Product Hunt Featured Embed Badge (Single Verified Placement) */}
          <motion.div
          ...
          <motion.div
            ...
            className="mt-6 border border-zinc-800 bg-zinc-950 rounded-xl overflow-hidden shadow-2xl backdrop-blur-md max-w-4xl mx-auto text-left"
          >
            {/* Window titlebar */}
